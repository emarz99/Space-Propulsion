...
% We will use "Infinite-Area Chamber (IAC)" on CEA's Rocket Problem
...
k = 1.26;                                       % Specific heat ratio frozen condition [-]
...
if 2*r_inj_ox > min_diam && 2*r_inj_fu > min_diam
    disp("Both dimensions of the injection orifices are feasible by AM");
elseif 2*r_inj_ox > min_diam && 2*r_inj_fu < min_diam
    disp("Oxydizer injector : OK and Fuel injector NOK");
else
    disp("Oxydizer injector : NOK and Fuel injector OK");
end
